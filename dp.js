...
app.get('/', (req, res) => {
    res.sendFile(path.join(__dirname, 'views', 'dp.html'));
});
...
app.post('/signup', async (req, res) => {
    ...
    try {
        ...
        const user = new User({
            name: firstName + ' ' + lastName,  // Make sure to assign the full name to the 'name' field
            email: email,
        ...
        res.redirect('/dp.html') // Redirect to homepage after sign-up
    } catch (error) {
        console.error(error);
...
app.post('/signin', async (req, res) => {
    ...
    try {
        ...
        res.redirect('/dp.html')  // Redirect to homepage after sign-in
    } catch (error) {
        console.error(error);
